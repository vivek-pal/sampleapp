/**-------------------------------------------------------------------------------------------
 * @module Capture Card Details feature
...
import { captureCardDetail } from "../../services/paymentInterfaceAdapterService";
import { buildCaptureCardDetailRequest } from "../../services/requestMapper/captureCardDetailReqMapper";
...
const CaptureCardDetails = () => {
    ...
    const onSubmit = (formData) => {
        ...
        let request = buildCaptureCardDetailRequest(data);
        const respons = captureCardDetail(request);
